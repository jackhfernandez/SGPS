namespace Presentacion
{
    partial class Login
    {
        ...
        private void InitializeComponent()
        {
            ...
            labelHeroAcento = new Label();
            labelHero3 = new Label();
            labelHero2 = new Label();
            labelHero1 = new Label();
            panelRegla = new Panel();
            ...
            btnDev = new Button();
            btnSm = new Button();
            panelLineaDerecha = new Panel();
            panelLineaIzquierda = new Panel();
            labelAccesoRapido = new Label();
            panelBoton = new Panel();
            btnIngresar = new Button();
            panelSombraBoton = new Panel();
            linkOlvido = new LinkLabel();
            chkRecordarme = new CheckBox();
            labelCandado = new Label();
            ...
            // 
            splitContainer1.Panel1.BackColor = Color.FromArgb(15, 59, 51);
            splitContainer1.Panel1.Controls.Add(labelHeroAcento);
            splitContainer1.Panel1.Controls.Add(labelHero3);
            splitContainer1.Panel1.Controls.Add(labelHero2);
            splitContainer1.Panel1.Controls.Add(labelHero1);
            splitContainer1.Panel1.Controls.Add(panelRegla);
            // 
            ...
            // panelAcceso
            // 
            panelAcceso.BackColor = Color.Transparent;
            panelAcceso.Controls.Add(btnCl);
            panelAcceso.Controls.Add(btnQa);
            panelAcceso.Controls.Add(btnDev);
            panelAcceso.Controls.Add(btnSm);
            panelAcceso.Controls.Add(panelLineaDerecha);
            panelAcceso.Controls.Add(panelLineaIzquierda);
            panelAcceso.Controls.Add(labelAccesoRapido);
            panelAcceso.Controls.Add(panelBoton);
            panelAcceso.Controls.Add(linkOlvido);
            panelAcceso.Controls.Add(chkRecordarme);
            panelAcceso.Controls.Add(labelCandado);
            panelAcceso.Controls.Add(txtContrasena);
            panelAcceso.Controls.Add(labelContrasena);
            ...
            // btnCl
            // 
            btnCl.BackColor = Color.FromArgb(245, 241, 232);
            btnCl.FlatAppearance.BorderColor = Color.FromArgb(218, 212, 196);
            ...
            // btnQa
            // 
            btnQa.BackColor = Color.FromArgb(245, 241, 232);
            btnQa.FlatAppearance.BorderColor = Color.FromArgb(218, 212, 196);
            ...
            // btnDev
            // 
            btnDev.BackColor = Color.FromArgb(245, 241, 232);
            btnDev.FlatAppearance.BorderColor = Color.FromArgb(218, 212, 196);
            ...
            // btnSm
            // 
            btnSm.BackColor = Color.FromArgb(245, 241, 232);
            btnSm.FlatAppearance.BorderColor = Color.FromArgb(218, 212, 196);
            ...
            // btnIngresar
            // 
            btnIngresar.BackColor = Color.FromArgb(12, 110, 99);
            btnIngresar.FlatAppearance.BorderSize = 0;
            btnIngresar.FlatAppearance.MouseDownBackColor = Color.FromArgb(10, 92, 83);
            btnIngresar.FlatAppearance.MouseOverBackColor = Color.FromArgb(14, 124, 113);
            ...
            // linkOlvido
            // 
            linkOlvido.ActiveLinkColor = Color.FromArgb(10, 92, 83);
            linkOlvido.BackColor = Color.FromArgb(245, 241, 232);
            ...
            linkOlvido.TextAlign = ContentAlignment.MiddleRight;
            linkOlvido.VisitedLinkColor = Color.FromArgb(15, 79, 71);
            // 
            // chkRecordarme
            // 
            ...
            labelTitulo.UseCompatibleTextRendering = true;
            // 
            // Login
            // 
        ...
        private Label labelHeroAcento;
        private Label labelHero3;
        private Label labelHero2;
        private Label labelHero1;
        private Panel panelRegla;
        private Label labelAcceso;
        private Panel panelAcceso;
        private Button btnCl;
        private Button btnQa;
        private Button btnDev;
        private Button btnSm;
        private Panel panelLineaDerecha;
        private Panel panelLineaIzquierda;
        private Label labelAccesoRapido;
        private Panel panelBoton;
        private Button btnIngresar;
        private Panel panelSombraBoton;
        private LinkLabel linkOlvido;
        private CheckBox chkRecordarme;
        private Label labelCandado;
